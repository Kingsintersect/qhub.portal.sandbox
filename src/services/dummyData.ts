...
const admissionCycles: AdmissionCycle[] = [
  {
    ...
    instructions:
      "All applicants must upload valid O'Level results and a recent passport photograph. Late applications attract an additional fee.",
    created_at: now,
    updated_at: now,
  },
  {
...
const admissionRequirements: AdmissionRequirement[] = [
  ...
  },
  {
    ...
    description:
      "Computer Science requires Physics in addition to general requirements",
  },
  {
    id: "ar-3",
    admission_cycle_id: "adc-1",
...
export const dummyAdmissionCycleApi = {
  ...
  async updateStatus(id: string, status: "draft" | "open" | "closed") {
    ...
    return {
      data: cycle,
      message: `Admission ${status === "open" ? "opened" : status === "closed" ? "closed" : "set to draft"}`,
    }
  },
}
...
const admissionApplications: AdmissionApplication[] = [
  {
    ...
    documents: [
      ...
      },
      {
        ...
        type: "identity",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-06-01T10:10:00Z",
      },
    ],
    ...
    documents: [
      {
        ...
        type: "certificate",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-06-02T09:00:00Z",
      },
      {
        id: "doc-5",
        name: "JAMB Result Slip",
        type: "certificate",
        url: "/slides/slide-3.webp",
        uploaded_at: "2024-06-02T09:05:00Z",
      },
    ],
    ...
    documents: [
      {
        ...
        type: "certificate",
        url: "/slides/slide-2.webp",
        uploaded_at: "2024-06-05T11:00:00Z",
      },
      {
        id: "doc-7",
        name: "Birth Certificate",
        type: "identity",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-06-05T11:10:00Z",
      },
      {
        id: "doc-8",
        name: "LGA Identification",
        type: "identity",
        url: "/slides/slide-3.webp",
        uploaded_at: "2024-06-05T11:15:00Z",
      },
    ],
    ...
    documents: [
      {
        ...
        type: "certificate",
        url: "/slides/slide-2.webp",
        uploaded_at: "2024-05-20T08:00:00Z",
      },
      {
        id: "doc-10",
        name: "JAMB Result Slip",
        type: "certificate",
        url: "/slides/slide-3.webp",
        uploaded_at: "2024-05-20T08:05:00Z",
      },
      {
        id: "doc-11",
        name: "Birth Certificate",
        type: "identity",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-05-20T08:10:00Z",
      },
    ],
  ...
  },
  {
    ...
    documents: [
      {
        ...
        type: "certificate",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-06-10T07:00:00Z",
      },
    ],
    ...
    reviewed_by: "Admin User",
    denial_reason:
      "JAMB score below minimum cut-off for the selected program. Missing Birth Certificate document.",
    ...
    documents: [
      {
        ...
        type: "certificate",
        url: "/slides/slide-1.webp",
        uploaded_at: "2024-06-08T14:00:00Z",
      },
      {
        id: "doc-14",
        name: "JAMB Result Slip",
        type: "certificate",
        url: "/slides/slide-2.webp",
        uploaded_at: "2024-06-08T14:05:00Z",
      },
      {
        id: "doc-15",
        ...
        type: "photo",
        url: "/slides/slide-3.webp",
        uploaded_at: "2024-06-08T14:10:00Z",
      },
    ],
...
export const dummyAdmissionApplicationApi = {
  ...
  async getByApplicantId(applicantId: string) {
    await delay(200)
    const app = admissionApplications.find(
      (x) => x.applicant_id === applicantId
    )
    if (!app) throw new Error("Application not found")
    return { data: { ...app } }
  },
  ...
  async review(id: string, payload: ReviewApplicationPayload) {
    ...
    app.denial_reason =
      payload.status === "denied" ? (payload.denial_reason ?? null) : null
...
const settings: Setting[] = [
  ...
  {
    id: 3,
    key: "university_motto",
    value: "Knowledge, Truth, Service",
    group: "university",
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
  },
  ...
  },
  {
    ...
    value: "1 University Road, Abuja, Nigeria",
    group: "university",
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
  },
  ...
  {
    id: 9,
    key: "academic_min_attendance_pct",
    value: "75",
    group: "academic",
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
  ...
  {
    id: 27,
    key: "system_support_email",
    value: "support@odl.edu.ng",
    group: "system",
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
  },
...
export const dummySettingsApi = {
  ...
  create: async (
    ...
    await delay()
    if (settings.some((s) => s.key === payload.key))
