      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-h-[60vh] overflow-y-auto pr-1">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
               ...
               <input
                  type="number" className={inputCls} placeholder="e.g. 8" required
                  value={form.user_id || ""}
            ...
            <div>
               ...
               <input
                  className={inputCls} placeholder="STF/2026/001" required
                        ...
                        <div className="flex-1 min-w-0">
                           <div className="flex items-center gap-2">
                              ...
                              <StatusBadge
                                 ...
                                 variant={a.offering.status === "OPEN" ? "success" : "default"}
                              />
                           </div>
