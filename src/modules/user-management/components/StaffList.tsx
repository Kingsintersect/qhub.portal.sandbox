...
import { useStaffList, useCreateStaff, useUpdateStaff, useStaffEligibleRoles } from "../hooks/useUsersData";
...
export default function StaffPage({ canDelete: canDeleteProp }: StaffPageProps = {}) {
                  ...
                  ...columns,
                  {
                     ...
                     render: (row) => (
                        <div className="flex gap-1">
                           <Button variant="ghost" size="sm" onClick={() => setSelected(row as unknown as Staff)} title="View">
                              <Eye size={14} />
                           </Button>
                           {/* Edit — departments:manage (SUPER_ADMIN) only */}
                           {canCreate && (
                              <Button variant="ghost" size="sm" onClick={() => setEditing(row as unknown as Staff)} title="Edit">
                                 <Pencil size={14} />
                              </Button>
                           )}
                        </div>
