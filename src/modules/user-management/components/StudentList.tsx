...
export default function StudentsPage({ canDelete: canDeleteProp, canCreate: canCreateProp, canExport: canExportProp }: StudentsPageProps = {}) {
                  ...
                  ...columns,
                  {
                     ...
                     render: (row) => (
                        <div className="flex gap-1">
                           <Button variant="ghost" size="sm" onClick={() => setSelected(row as unknown as Student)} title="View">
                              <Eye size={14} />
                           </Button>
                           {/* Edit — users:manage only */}
                           {canCreate && (
                              <Button variant="ghost" size="sm" onClick={() => setEditing(row as unknown as Student)} title="Edit">
                                 <Pencil size={14} />
                              </Button>
                           )}
                        </div>
