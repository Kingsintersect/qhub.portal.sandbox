...
export function NotificationList() {
    ...
    const { data, isLoading, isError, refetch, isFetching } = useNotifications(filters);
    ...
    const { data: notifications = [], meta } = data ?? { data: [], meta: { total: 0, page: 1, limit: 20, unreadCount: 0 } };
        ...
        <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    {meta.unreadCount > 0 && (
                        <span className="inline-flex items-center justify-center h-5 min-w-5 px-1.5 rounded-full bg-blue-500 text-white text-[11px] font-semibold tabular-nums">
                            {meta.unreadCount}
                        </span>
                    )}
                </div>
                ...
                {notifications.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 gap-3">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {statusFilter === "SENT" ? "No unread notifications." : "No notifications found."}
                        </p>
                    </div>
                ) : (
