...
function getCourseSyncStatus(lastSyncAt: string | null, failedCount: number): SyncStatus {
   if (failedCount > 0) return "FAILED";
   if (lastSyncAt && (Date.now() - new Date(lastSyncAt).getTime()) > 24 * 60 * 60 * 1000) return "STALE";
   return "SYNCED";
}
