...
import { fresherFeeSchema, type FresherFeeFormValues } from "@/schemas/school.schema";
...
export function FreshersFeeManager({ canManage = false, canConfigure = false }: FreshersFeeManagerProps) {
