...
interface FreshersFeeManagerProps {
  canManage?: boolean
...
export function FreshersFeeManager({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage application, acceptance, and other first-year fees for
            100-level students.
          </p>
        </div>
        {canManage && (
      ...
      {/* Create Form - only show if user can manage */}
      {selectedSessionId && showForm && canManage && (
        <Card>
          <CardHeader>
            <CardTitle>Add Fresher Fee</CardTitle>
            <CardDescription>
              Add a fee item for 100-level students (e.g., Application Fee,
              Acceptance Fee).
            </CardDescription>
          </CardHeader>
          <CardContent>
