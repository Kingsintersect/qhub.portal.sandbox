...
import { RevenueAreaChart, ProgramBarChart, TypeDonutChart } from "../charts/revenue-charts";
...
export default function FinancialSummaryPage({
   ...
   if (!canView && !canManage && !canViewTransactions) return null;
   ...
   return (
      <div className="min-h-screen bg-background">
         <div className="max-w-400 mx-auto px-4 sm:px-6 py-6 space-y-6">
            ...
            {/* ─── Tab Navigation ───────────────────────────────────────────────── */}
            {(canView || canManage || canViewTransactions) && (
            ...
            <AnimatePresence mode="wait">
               {/* ── Overview Tab ─────────────────────────────────────────────── */}
               {activeTab === "overview" && dashData && (canView || canManage) && (
                  <motion.div
                     key="overview"
               ...
               {/* ── Transactions Tab ──────────────────────────────────────────── */}
               {activeTab === "transactions" && (canViewTransactions || canManage) && (
                  <motion.div
                     key="transactions"
                     initial={{ opacity: 0, y: 12 }}
                     animate={{ opacity: 1, y: 0 }}
               ...
               {/* ── Grouped Tab ───────────────────────────────────────────────── */}
               {activeTab === "grouped" && (canViewTransactions || canManage) && (
                  <motion.div
                     key="grouped"
                     initial={{ opacity: 0, y: 12 }}
                     animate={{ opacity: 1, y: 0 }}
