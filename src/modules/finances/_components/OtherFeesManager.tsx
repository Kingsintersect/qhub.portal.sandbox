...
import { otherFeeSchema, type OtherFeeFormValues } from "@/schemas/school.schema";
...
export function OtherFeesManager({ canManage = false, canConfigure = false }: OtherFeesManagerProps) {
