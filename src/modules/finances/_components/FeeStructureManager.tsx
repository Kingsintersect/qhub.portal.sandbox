...
export function FeeStructureManager({
  ...
  const { data: feeStructures, isLoading } = useFeeStructures(selectedSessionId)
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-1 text-sm shadow-xs focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none aria-invalid:border-destructive aria-invalid:ring-destructive"
                >
                  ...
                  {feeStructures?.map((fee) => (
                    ...
                    >
                      <td className="px-4 py-3">
                        {sessionMap.get(fee.academic_session_id) ??
