...
export default function PublishResultsPage({ canPublish = false, canManage = false }: PublishResultsPageProps) {
         ...
         <AnimatePresence>
            {gradesLoaded && (
               ...
               >
                  ...
                  {/* Table */}
                  <PublishResultsTable grades={loadedGrades} canPublish={canPublish} />
               </motion.div>
            )}
         </AnimatePresence>
