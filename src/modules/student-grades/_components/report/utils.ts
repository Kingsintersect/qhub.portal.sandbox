...
import type { ReportCourse, ReportGradeDistributionItem, ReportStudentInfo, ReportSummary } from "./types";
...
export function calculateReportSummary(courses: ReportCourse[]): ReportSummary {
   ...
   const gradeDistribution: ReportGradeDistributionItem[] = GRADE_META.map((meta) => {
