...
const buttonVariants = cva(
   // keep these: relative/isolate are required for ::before glow
   "cursor-pointer group/button relative isolate inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
   {
      variants: {
         variant: {
...
function Button({
   ...
   const shouldGlow = glow && (variant === "default" || variant === "outline")
   ...
   return (
      <Comp
         ...
         data-size={size}
         data-glow={shouldGlow ? "true" : "false"}
         className={cn(buttonVariants({ variant, size }), shouldGlow && "btn-glow", className)}
         {...props}
      />
   )
}
