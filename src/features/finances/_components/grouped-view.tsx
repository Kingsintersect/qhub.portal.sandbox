                                                   ...
                                                   <td className="px-3 py-2 text-right">
                                                      <div className="flex items-center justify-end gap-1">
                                                         ...
                                                         {canManage && (
                                                            <button
                                                               onClick={() => onViewInvoice(tx)}
                                                               className="p-1 rounded-lg hover:bg-primary hover:text-white text-muted-foreground transition"
                                                               title="Edit"
                                                            >
