...
export function CourseList({ canManage = false }: CourseListProps) {
   ...
   const hasFilters = filterLevel || filterSemester || filterType || search;
                     ...
                     <CardContent className="pb-12">
                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                           ...
                           <div className="space-y-1.5">
                              ...
                              />
                              {errors.credit_units && <p className="text-sm text-destructive">{errors.credit_units.message}</p>}
                           </div>
                           <div className="space-y-1.5">
                           ...
                           <div className="space-y-1.5">
                              ...
                              />
                              {errors.curriculum_semester_id && <p className="text-sm text-destructive">{errors.curriculum_semester_id.message}</p>}
                           </div>
                           <div className="space-y-1.5 sm:col-span-2 lg:col-span-3">
                              <Label htmlFor="description">Description (optional)</Label>
                              <Input id="description" placeholder="Brief description of the course" {...register("description")} />
                           </div>
                        </div>
                     ...
                     <Card className="relative">
                        ...
                        <CardContent>
                           <div className="mb-3 space-y-1 text-xs text-muted-foreground">
                              <p><span className="font-medium text-foreground">{course.credit_units}</span> credit unit{course.credit_units !== 1 ? "s" : ""}</p>
                              <p>{course.level_name} — {course.semester_name}</p>
                              {course.department_name && <p>Dept: {course.department_name}</p>}
                           </div>
                           {canManage && (
                              <Button variant="outline" size="sm" className="w-full" onClick={() => startEdit(course)}>
