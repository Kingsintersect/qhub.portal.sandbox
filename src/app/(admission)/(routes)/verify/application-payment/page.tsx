...
import { useVerifyApplicationPayment } from "../../..//hooks/useAdmissionQueries";
import { Skeleton } from "@/components/ui/skeleton";
import { PaymentVerificationView } from "../../../components";

function VerifyApplicationPaymentContent() {
...
export default function VerifyApplicationPaymentPage() {
    return (
        <Suspense
            fallback={
        ...
        >
            <VerifyApplicationPaymentContent />
        </Suspense>
    );
}