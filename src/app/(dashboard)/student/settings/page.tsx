...
import { useAppHydrated, useAppStore, useNotificationStore, useThemeStore } from "@/store";
      ...
      <div className="space-y-6">
         <section className="overflow-hidden rounded-3xl border border-primary/20 bg-linear-to-br from-primary/15 via-background to-cyan-500/10 p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
               <div>
                  ...
                  <h1 className="mt-2 text-2xl font-bold text-foreground sm:text-3xl">Student Settings</h1>
                  <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                     Manage your profile, security, notification channels, and portal experience in one place.
                  </p>
               </div>
         ...
         <Tabs defaultValue="profile" className="space-y-4">
            <TabsList className="h-auto flex-wrap justify-start rounded-2xl border border-border bg-card p-2">
               ...
               <TabsTrigger value="notifications" className="gap-1.5 rounded-xl px-3 py-2">
                  <Bell size={14} />
                  Notifications
               </TabsTrigger>
               <TabsTrigger value="preferences" className="gap-1.5 rounded-xl px-3 py-2">
                  <Palette size={14} />
                  Preferences
               </TabsTrigger>
               <TabsTrigger value="security" className="gap-1.5 rounded-xl px-3 py-2">
                  <Lock size={14} />
                  Security
               </TabsTrigger>
            </TabsList>
                  ...
                  <CardContent className="space-y-4">
                     <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                           ...
                           <Input id="level" value={level} onChange={(event) => setLevel(event.target.value)} />
                        </div>
                        <div className="space-y-2">
                           ...
                           <Input
                              ...
                              onChange={(event) => patchSettings({ phoneNumber: event.target.value })}
                           />
                        </div>
                        <div className="space-y-2">
                           <Label htmlFor="avatar-url">Avatar URL (from backend if available)</Label>
                     ...
                     <div className="space-y-2">
                        ...
                        <Textarea
                           id="bio"
                           value={settings.bio}
                           onChange={(event) => patchSettings({ bio: event.target.value })}
                  ...
                  <CardContent className="space-y-4">
                     <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="space-y-2">
                           ...
                           <Select value={settings.language} onValueChange={(value) => patchSettings({ language: value as "en" | "fr" })}>
                              <SelectTrigger>
                        ...
                        <div className="space-y-2">
                           ...
                           <Select value={settings.timezone} onValueChange={(value) => patchSettings({ timezone: value })}>
                              <SelectTrigger>
                     ...
                     <SettingsToggle
                        ...
                        onCheckedChange={(checked) => patchSettings({ reducedMotion: checked })}
                     />
                  ...
                  <CardContent className="space-y-5">
                     ...
                     <SettingsToggle
                        ...
                        onCheckedChange={(checked) => {
                           ...
                           toast.success(checked ? "Two-factor enabled." : "Two-factor disabled.");
                        }}
                     />
                        ...
                        <div className="flex items-start gap-2">
                           ...
                           <div>
                              ...
                              <p className="mt-1 text-xs">
                                 If you signed in on a shared device, use logout from the user menu to end your session.
                              </p>
                           </div>
                        </div>
                     </div>
