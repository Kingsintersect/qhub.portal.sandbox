...
import { ShieldOff, Clock, Search, Filter } from "lucide-react";
      ...
      >
         <div className="space-y-6">
            <section className="rounded-3xl border border-primary/20 bg-linear-to-br from-primary/15 via-background to-cyan-500/10 p-6">
               <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Next 14 Days</p>
               <h1 className="mt-2 text-2xl font-bold text-foreground sm:text-3xl">Upcoming Events</h1>
            ...
            <section className="rounded-3xl border border-border/70 bg-card/95 p-5 shadow-sm">
               <div className="mb-4 flex items-center gap-2">
                  ...
                  <p className="text-sm font-semibold text-foreground">Filter Upcoming</p>
               </div>
