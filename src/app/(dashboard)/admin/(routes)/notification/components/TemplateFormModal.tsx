...
const schema = z.object({
   ...
   channel: z.enum(["EMAIL", "SMS", "IN_APP", "PUSH"], { error: "Channel required" }),
});
      ...
      >
         <div className="p-5 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
               ...
               <div className="space-y-1.5">
                  ...
                  {errors.name ? (
                     ...
                     <p className="text-xs text-muted-foreground">Unique slug, lowercase_snake_case</p>
                  )}
               </div>
               ...
               <div className="space-y-1.5">
                  ...
                  <Select
                     value={channel}
                     onValueChange={(v) => setValue("channel", v as FormValues["channel"], { shouldValidate: true })}
                  >
            ...
            <div className="space-y-1.5">
               ...
               <Input
                  id="tpl-subject"
                  placeholder="e.g. Welcome to {{university_name}}, {{firstName}}!"
            ...
            <div className="space-y-1.5">
               ...
               {errors.body ? (
                  ...
                  <p className="text-xs text-muted-foreground">
                     Use <code className="bg-muted px-1 rounded">{"{{variableName}}"}</code> for dynamic values
                  </p>
               )}
            </div>
         </div>
