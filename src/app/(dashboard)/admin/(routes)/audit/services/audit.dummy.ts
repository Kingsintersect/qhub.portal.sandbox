...
const USERS: Record<number, AuditUser> = {
  ...
  3: {
    firstName: "Babatunde",
    lastName: "Adeyemi",
    email: "b.adeyemi@unilag.edu.ng",
  },
  4: { firstName: "Ngozi", lastName: "Okoye", email: "n.okoye@unilag.edu.ng" },
  5: {
    firstName: "Amaka",
    lastName: "Ezenwachi",
    email: "u21sc1234@unilag.edu.ng",
  },
  6: {
    firstName: "Emeka",
    lastName: "Nwosu",
    email: "u22cs0087@unilag.edu.ng",
  },
...
export const ALL_AUDIT_LOGS: AuditLog[] = [
  ...
  mkLog(
    ...
    null,
    { studentId: 5, courseId: 101, caScore: 22, examScore: 0 },
    2
  ),
  mkLog(
    14,
    ...
    "Grade",
    2002,
    "2024-11-15T14:05:00Z",
    null,
    { studentId: 6, courseId: 101, caScore: 18, examScore: 0 },
    2
  ),
  mkLog(
    15,
    ...
    null,
    { studentId: 5, courseId: 103, caScore: 25, examScore: 0 },
    2
  ),
  ...
  mkLog(
    ...
    null,
    { invoiceId: 3001, amount: 195000, method: "Remita", ref: "REM2024120001" },
    4,
    true
  ),
  mkLog(
    ...
    null,
    { invoiceId: 3002, amount: 97500, method: "Remita", ref: "REM2024120002" },
    4,
    true
  ),
  mkLog(
    ...
    { caScore: 22, examScore: 0 },
    { caScore: 22, examScore: 55 },
    2
  ),
  mkLog(
    23,
    ...
    "Grade",
    2002,
    "2024-12-10T16:05:00Z",
    { caScore: 18, examScore: 0 },
    { caScore: 18, examScore: 47 },
    2
  ),
  mkLog(
    24,
    ...
    { caScore: 25, examScore: 0 },
    { caScore: 25, examScore: 62 },
    2
  ),
  ...
  mkLog(
    ...
    null,
    { studentId: 5, semester: "First", academicYear: "2024/2025" },
    6
  ),
  mkLog(
    31,
  ...
  mkLog(
    ...
    null,
    { moodleId: "u21sc1234", synced: true },
    1
  ),
  mkLog(
    33,
    ...
    "MoodleUser",
    6,
    "2025-01-15T02:01:00Z",
    null,
    { moodleId: "u22cs0087", synced: true },
    1
  ),
  ...
  mkLog(
    ...
    { semesterActive: "First" },
    { semesterActive: "Second" },
    0
  ),
  mkLog(
    35,
  ...
  mkLog(
    ...
    null,
    { invoiceId: 3003, amount: 30000, method: "Remita", ref: "REM2025030001" },
    3,
    true
  ),
  mkLog(
    ...
    { title: "Old Notice", body: "Outdated info" },
    null,
    0
  ),
  mkLog(
    ...
    null,
    { title: "2nd Semester Timetable Released", body: "Check portal" },
    1
  ),
  ...
  mkLog(
    ...
    null,
    { studentId: 5, courseId: 104, caScore: 27, examScore: 0 },
    2
  ),
  mkLog(
    45,
    ...
    null,
    { studentId: 6, courseId: 105, caScore: 20, examScore: 0 },
    2
  ),
  mkLog(
    46,
    ...
    null,
    { invoiceId: 3002, amount: 97500, method: "Bank", ref: "BANK2025040001" },
    4,
    true
  ),
  mkLog(
    ...
    null,
    { status: "rejected", reason: "CA score out of range" },
    0
  ),
  mkLog(
    48,
  ...
  mkLog(
    ...
    { caScore: 20, examScore: 0 },
    { caScore: 20, examScore: 58 },
    2
  ),
  mkLog(
    51,
    ...
    "Grade",
    2004,
    "2025-05-02T14:10:00Z",
    { caScore: 24, examScore: 0 },
    { caScore: 24, examScore: 67 },
    2
  ),
  mkLog(
    52,
  ...
  mkLog(
    ...
    null,
    { synced: true, moodleCourseId: 304 },
    1
  ),
  mkLog(
    54,
    ...
    "MoodleEnrollment",
    1005,
    "2025-05-06T02:01:00Z",
    null,
    { synced: true, moodleCourseId: 305 },
    1
  ),
  ...
  mkLog(
    ...
    null,
    { type: "Transcript", studentId: 5, generated: true },
    6
  ),
  mkLog(
    59,
    ...
    { email: "spam@fake.com", role: "Student" },
    null,
    0
  ),
  ...
  mkLog(
    ...
    null,
    { invoiceId: 3004, amount: 210000, method: "Remita", ref: "REM2025120001" },
    3,
    true
  ),
  mkLog(
    ...
    null,
    { studentId: 5, courseId: 106, caScore: 28, examScore: 0 },
    2
  ),
  mkLog(
    64,
  ...
  mkLog(
    ...
    null,
    { synced: true, lastSync: "2026-02-15" },
    1
  ),
  ...
  mkLog(
    ...
    null,
    { reason: "Outstanding library fine" },
    0
  ),
  mkLog(
    69,
  ...
  mkLog(
    ...
    null,
    { invoiceId: 3005, amount: 210000, method: "Remita", ref: "REM2026040001" },
    4,
    true
  ),
...
export function getDummyEntityLogs(
  ...
  return {
    data: logs.map(
      ({ id, userId, user, action, oldValues, newValues, createdAt }) => ({
        id,
        userId,
