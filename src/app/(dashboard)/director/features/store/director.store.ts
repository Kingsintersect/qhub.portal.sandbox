      ...
      (set, get) => ({
         ...
         fetchOverview: async () => {
            ...
            try {
               ...
               setError("overview", err instanceof Error ? err.message : "Failed to load overview");
            } finally {
         ...
         fetchFinancialSummary: async (filter) => {
            ...
            try {
               ...
               setError("financial", err instanceof Error ? err.message : "Failed to load financial data");
            } finally {
         ...
         fetchStatisticalReport: async (filter) => {
            ...
            try {
               ...
               setError("statistical", err instanceof Error ? err.message : "Failed to load statistical report");
            } finally {
         ...
         fetchGradeReport: async (filter) => {
            ...
            try {
               ...
               setError("grades", err instanceof Error ? err.message : "Failed to load grade report");
            } finally {
